import{V as A,_ as G,c as V,a as g,w as b,e as w,b as s,d as l,r as x,o as O}from"./app.c8c7bdbc.js";const{defineComponent:R}=A,I=R({name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:u,openBlock:r,createBlock:c}=A;function p(e,n){const y=u("xs-table");return r(),c(y,{columns:e.columns,data:e.data},null,8,["columns","data"])}const{ref:D}=A;return{render:p,...{setup(){const e=D(Array.from({length:10}).map((y,F)=>({date:`2023-01-1${F}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),n=D([{prop:"date",label:"Date",width:180},{prop:"name",label:"Name",width:180},{prop:"address",label:"Address"}]);return{data:e,columns:n}}}}}(),"render-demo-1":function(){const{toDisplayString:u,createTextVNode:r,resolveComponent:c,withCtx:p,createVNode:D,Fragment:f,openBlock:e,createElementBlock:n}=A;function y(d,o){const i=c("xs-button"),t=c("xs-table");return e(),n(f,null,[D(i,{type:"primary",onClick:o[0]||(o[0]=E=>d.loading=!d.loading)},{default:p(()=>[r(u(d.loading?"\u5173\u95ED":"\u6253\u5F00")+"\u52A0\u8F7D",1)]),_:1}),D(t,{columns:d.columns,data:d.data,loading:d.loading,"skeleton-rows":10},null,8,["columns","data","loading"])],64)}const{ref:F}=A;return{render:y,...{setup(){const d=F(Array.from({length:10}).map((t,E)=>({date:`2023-01-1${E}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),o=F(!0),i=F([{prop:"date",label:"Date",width:180},{prop:"name",label:"Name",width:180},{prop:"address",label:"Address"}]);return{data:d,columns:i,loading:o}}}}}(),"render-demo-2":function(){const{toDisplayString:u,createTextVNode:r,resolveComponent:c,withCtx:p,createVNode:D,openBlock:f,createBlock:e,createCommentVNode:n,createElementVNode:y,createSlots:F,Fragment:a,createElementBlock:d}=A,o={style:{"margin-bottom":"12px"}};function i(C,B){const m=c("xs-button"),h=c("xs-table");return f(),d(a,null,[y("div",o,[D(m,{type:"warning",onClick:B[0]||(B[0]=v=>C.pagination=!C.pagination)},{default:p(()=>[r(u(C.pagination?"\u5173\u95ED":"\u6253\u5F00")+"\u5206\u9875",1)]),_:1}),C.pagination?(f(),e(m,{key:0,type:"primary",onClick:C.setPage},{default:p(()=>[r("\u8C03\u6574\u9875\u957F\u548C\u9875\u957F\u9009\u9879")]),_:1},8,["onClick"])):n("",!0),C.pagination?(f(),e(m,{key:1,type:"danger",onClick:B[1]||(B[1]=v=>C.slotVisible=!C.slotVisible)},{default:p(()=>[r(u(C.slotVisible?"\u5173\u95ED":"\u663E\u793A")+" \u63D2\u69FD ",1)]),_:1})):n("",!0)]),D(h,{columns:C.columns,data:C.data,pagination:C.pagination,"reset-position-on-data-change":!1},F({_:2},[C.slotVisible?{name:"paginationLeft",fn:p(()=>[D(m,{type:"warning"},{default:p(()=>[r("\u5206\u9875\u5DE6\u4FA7slot")]),_:1})]),key:"0"}:void 0,C.slotVisible?{name:"paginationRight",fn:p(()=>[D(m,{type:"warning"},{default:p(()=>[r("\u5206\u9875\u53F3\u4FA7slot")]),_:1})]),key:"1"}:void 0]),1032,["columns","data","pagination"])],64)}const{ref:t}=A;return{render:i,...{setup(){const C=t(Array.from({length:10}).map((_,k)=>({date:`2023-01-1${k}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),B=t([{prop:"date",label:"Date",fixed:!0},{prop:"name",label:"Name"},{prop:"address",label:"Address",width:600}]),m=t(!0),h=()=>{typeof m.value=="object"?m.value=!0:m.value={layout:"sizes, prev, pager, next, total",position:"flex-start",pageSizes:[25,50,100],pageSize:50}},v=t(!1);return{data:C,columns:B,setPage:h,pagination:m,slotVisible:v}}}}}(),"render-demo-3":function(){const{toDisplayString:u,createTextVNode:r,resolveComponent:c,withCtx:p,createVNode:D,openBlock:f,createBlock:e,createCommentVNode:n,Fragment:y,createElementBlock:F}=A;function a(i,t){const E=c("xs-button"),C=c("xs-table");return f(),F(y,null,[D(E,{type:"primary",onClick:i.toggleStripe},{default:p(()=>[r(u(i.stripe?"\u5173\u95ED":"\u6253\u5F00")+"\u6591\u9A6C\u7EB9 ",1)]),_:1},8,["onClick"]),i.stripe?(f(),e(E,{key:0,type:"danger",onClick:i.changeIndex},{default:p(()=>[r(" \u5207\u6362\u6591\u9A6C\u7EB9\u7684\u8D77\u59CB\u5E8F\u53F7 ")]),_:1},8,["onClick"])):n("",!0),D(C,{columns:i.columns,data:i.data,stripe:i.stripe,"stripe-index":i.stripeIndex},null,8,["columns","data","stripe","stripe-index"])],64)}const{ref:d}=A;return{render:a,...{setup(){const i=d(Array.from({length:10}).map((h,v)=>({date:`2023-01-1${v}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),t=d(!0),E=d(0),C=()=>{t.value=!t.value},B=()=>{E.value?E.value=0:E.value=1},m=d([{prop:"date",label:"Date",width:180},{prop:"name",label:"Name",width:180},{prop:"address",label:"Address"}]);return{data:i,columns:m,toggleStripe:C,stripe:t,stripeIndex:E,changeIndex:B}}}}}(),"render-demo-4":function(){const{resolveComponent:u,openBlock:r,createBlock:c}=A;function p(e,n){const y=u("xs-table");return r(),c(y,{columns:e.columns,data:e.data,border:""},null,8,["columns","data"])}const{ref:D}=A;return{render:p,...{setup(){const e=D(Array.from({length:10}).map((y,F)=>({date:`2023-01-1${F}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),n=D([{prop:"date",label:"Date",width:180},{prop:"name",label:"Name",width:180},{prop:"address",label:"Address"}]);return{data:e,columns:n}}}}}(),"render-demo-5":function(){const{resolveComponent:u,openBlock:r,createBlock:c}=A;function p(e,n){const y=u("xs-table");return r(),c(y,{columns:e.columns,data:e.data,"row-class-name":e.tableRowClassName,abc:1},null,8,["columns","data","row-class-name"])}const{ref:D}=A;return{render:p,...{setup(){const e=D(Array.from({length:10}).map((F,a)=>({date:`2023-01-1${a}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),n=({row:F,rowIndex:a})=>a===0?"warning-row":a===3?"success-row":"",y=D([{prop:"date",label:"Date",width:180},{prop:"name",label:"Name",width:180},{prop:"address",label:"Address"}]);return{data:e,columns:y,tableRowClassName:n}}}}}(),"render-demo-6":function(){const{resolveComponent:u,openBlock:r,createBlock:c}=A;function p(e,n){const y=u("xs-table");return r(),c(y,{columns:e.columns,data:e.data,height:"250"},null,8,["columns","data"])}const{ref:D}=A;return{render:p,...{setup(){const e=D(Array.from({length:10}).map((y,F)=>({date:`2023-01-1${F}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),n=D([{prop:"date",label:"Date",width:180},{prop:"name",label:"Name",width:180},{prop:"address",label:"Address"}]);return{data:e,columns:n}}}}}(),"render-demo-7":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,openBlock:D,createBlock:f}=A;function e(F,a){const d=r("xs-button"),o=r("xs-table");return D(),f(o,{columns:F.columns,data:F.data},{operations:c(()=>[p(d,{link:"",type:"danger",size:"small"},{default:c(()=>[u("\u5220\u9664")]),_:1})]),_:1},8,["columns","data"])}const{ref:n}=A;return{render:e,...{setup(){const F=n(Array.from({length:10}).map((d,o)=>({date:`2023-01-1${o}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),a=n([{prop:"date",label:"Date",width:100,fixed:!0},{prop:"name",label:"Name",width:200},{prop:"state",label:"State",width:200},{prop:"city",label:"City",width:200},{prop:"address",label:"Address",width:600},{slot:"operations",label:"Operations",width:120,fixed:"right"}]);return{data:F,columns:a}}}}}(),"render-demo-8":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,Fragment:D,openBlock:f,createElementBlock:e}=A;function n(a,d){const o=r("xs-button"),i=r("xs-table");return f(),e(D,null,[p(i,{columns:a.columns,data:a.data,"max-height":"250"},{operations:c(({$index:t})=>[p(o,{type:"link",size:"small",onClick:E=>a.deleteRow(t)},{default:c(()=>[u("\u5220\u9664")]),_:2},1032,["onClick"])]),_:1},8,["columns","data"]),p(o,{style:{width:"100%","margin-top":"12px"},onClick:a.addRow},{default:c(()=>[u("\u589E\u52A0\u4E00\u9879\u5230\u8868\u683C")]),_:1},8,["onClick"])],64)}const{ref:y}=A;return{render:n,...{setup(){const a=y(Array.from({length:2}).map((t,E)=>({date:`2023-01-1${E}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),d=t=>{a.value.splice(t,1)},o=()=>{a.value.length>=10||a.value.push({date:`2023-01-1${a.value.length}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036"})},i=y([{prop:"date",label:"Date",width:100,fixed:!0},{prop:"name",label:"Name",width:200},{prop:"state",label:"State",width:200},{prop:"city",label:"City",width:200},{prop:"address",label:"Address",width:600},{slot:"operations",label:"Operations",width:120,fixed:"right"}]);return{data:a,columns:i,deleteRow:d,addRow:o}}}}}(),"render-demo-9":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,openBlock:D,createBlock:f}=A;function e(F,a){const d=r("xs-button"),o=r("xs-table");return D(),f(o,{columns:F.columns,data:F.data},{operations:c(()=>[p(d,{link:"",type:"danger",size:"small"},{default:c(()=>[u("\u5220\u9664")]),_:1})]),_:1},8,["columns","data"])}const{ref:n}=A;return{render:e,...{setup(){const F=n(Array.from({length:10}).map((d,o)=>({date:`2023-01-1${o}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),a=n([{prop:"date",label:"Date",fixed:!0},{prop:"name",label:"Name",align:"center",children:[{prop:"tag",label:"Tag",align:"center"},{prop:"zip",label:"Zip",align:"center"}]},{prop:"address",label:"Address",showOverflowTooltip:!0}]);return{data:F,columns:a}}}}}(),"render-demo-10":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,createElementVNode:D,Fragment:f,openBlock:e,createElementBlock:n}=A,y=D("br",null,null,-1),F=D("br",null,null,-1),a=D("br",null,null,-1);function d(t,E){const C=r("xs-button"),B=r("xs-table");return e(),n(f,null,[p(C,{type:"primary",onClick:E[0]||(E[0]=m=>t.themeColor="#e1f3d8")},{default:c(()=>[u("\u6253\u5F00\u4E3B\u9898\u8272")]),_:1}),p(C,{type:"danger",onClick:E[1]||(E[1]=m=>t.themeColor="")},{default:c(()=>[u("\u5173\u95ED\u4E3B\u9898\u8272")]),_:1}),y,F,p(B,{columns:t.columns,data:t.data,"theme-color":t.themeColor},null,8,["columns","data","theme-color"]),a,p(B,{columns:t.columns2,data:t.data,"theme-color":t.themeColor},{tagLabel:c(()=>[p(C,{type:"link"},{default:c(()=>[u("\u81EA\u5B9A\u4E49\u5934\u90E8")]),_:1})]),_:1},8,["columns","data","theme-color"])],64)}const{ref:o}=A;return{render:d,...{setup(){const t=o(Array.from({length:4}).map((m,h)=>({date:`2023-01-1${h}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:null,tag:null,zip2:"\u6211\u5728\u9F13\u697C",tag2:"\u6625\u5929\u82B1\u4F1A\u5F00",zip3:"--",tag3:"--"}))),E=o(""),C=o([{type:"index",index:m=>m*2,background:"#c5d3f4",label:"#",align:"center"},{prop:"date",label:"Date",background:"#e1f3d8"},{prop:"name",label:"Name",background:"#ffd180"},{prop:"address",label:"Address",background:"#d78e6a"}]),B=o([{prop:"date",label:"Date",fixed:!0,width:150},{prop:"name",label:"Name",align:"center",background:"#fcd3d3",group:"userName",children:[{prop:"tag",label:"Tag",align:"center",background:"#ffd180",slotLabel:"tagLabel",width:220},{prop:"zip",label:"\u7EE7\u627Fname\u7684\u989C\u8272",align:"center",width:320}]},{prop:"name",label:"Name",align:"center",background:"#e1f3d8",group:"userName2",children:[{prop:"tag2",label:"Tag",width:220,align:"center"},{prop:"zip2",label:"Zip",width:200,align:"center"}]},{prop:"name",label:"Name",align:"center",background:"#fcd3d3",group:"userName3",children:[{prop:"tag3",label:"Tag",align:"center",background:"#ffd180",slotLabel:"tagLabel",width:220},{prop:"zip3",label:"\u7EE7\u627Fname\u7684\u989C\u8272",align:"center",width:220}]},{prop:"address",label:"Address",showOverflowTooltip:!0}]);return{data:t,columns:C,columns2:B,themeColor:E}}}}}(),"render-demo-11":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,openBlock:D,createBlock:f}=A;function e(F,a){const d=r("xs-button"),o=r("xs-table");return D(),f(o,{columns:F.columns,data:F.data},{operations:c(()=>[p(d,{link:"",type:"danger",size:"small"},{default:c(()=>[u("\u5220\u9664")]),_:1})]),_:1},8,["columns","data"])}const{ref:n}=A;return{render:e,...{setup(){const F=n(Array.from({length:10}).map((d,o)=>({date:`2023-01-1${o}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),a=n([{type:"selection",width:60,align:"center"},{type:"index",width:60,label:"#"},{prop:"date",label:"Date"},{prop:"name",label:"Name"},{prop:"address",label:"Address"}]);return{data:F,columns:a}}}}}(),"render-demo-12":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,createElementVNode:D,Fragment:f,openBlock:e,createElementBlock:n}=A,y={style:{"margin-bottom":"12px"}};function F(o,i){const t=r("xs-button"),E=r("xs-table");return e(),n(f,null,[D("div",y,[p(t,{type:"warning",onClick:i[0]||(i[0]=C=>o.onClick(2))},{default:c(()=>[u("\u9009\u4E2D\u7B2C\u4E09\u884C")]),_:1}),p(t,{type:"primary",onClick:o.onClick},{default:c(()=>[u("\u6E05\u9664\u9009\u4E2D")]),_:1},8,["onClick"])]),p(E,{ref:"tableRef",columns:o.columns,data:o.data,"highlight-current-row":"",onCurrentChange:o.onCurrentChange},null,8,["columns","data","onCurrentChange"])],64)}const{ref:a}=A;return{render:F,...{setup(){const o=a(null),i=a(Array.from({length:10}).map((B,m)=>({date:`2023-01-1${m}`,age:m+1,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),t=a([{type:"index",width:60,label:"#",align:"center"},{prop:"date",label:"Date",sortable:!0},{prop:"age",label:"Age",sortable:!0},{prop:"name",label:"Name",render:({column:B,row:m,rows:h,columns:v,$index:_})=>`${m.name}-${h.length}-${v.length}-${B.prop}-${_}`},{prop:"address",showOverflowTooltip:!0,label:"Address"}]);return{data:i,tableRef:o,columns:t,onCurrentChange:({currentRowIndex:B})=>{alert(B===-1?"\u53D6\u6D88\u5355\u9009":`\u9009\u4E2D\u4E86\u7B2C${B+1}\u884C`)},onClick:B=>{o.value.setCurrentRow(B)}}}}}}(),"render-demo-13":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,createElementVNode:D,Fragment:f,openBlock:e,createElementBlock:n}=A,y={style:{"margin-bottom":"12px"}};function F(o,i){const t=r("xs-button"),E=r("xs-table");return e(),n(f,null,[D("div",y,[p(t,{type:"warning",onClick:i[0]||(i[0]=C=>o.sort={prop:"date",order:"descending"})},{default:c(()=>[u("\u6309Date\u964D\u5E8F")]),_:1}),p(t,{type:"primary",onClick:i[1]||(i[1]=C=>o.sort={prop:"age",order:"ascending"})},{default:c(()=>[u("\u6309Age\u5347\u5E8F")]),_:1})]),p(E,{columns:o.columns,data:o.data,sort:o.sort},null,8,["columns","data","sort"])],64)}const{ref:a}=A;return{render:F,...{setup(){const o=a(Array.from({length:10}).map((E,C)=>({date:`2023-01-1${C}`,age:C+1,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),i=a([{type:"index",width:60,label:"#",align:"center"},{prop:"date",label:"Date",sortable:!0},{prop:"age",label:"Age",sortable:!0},{prop:"name",label:"Name",render:({column:E,row:C,rows:B,columns:m,$index:h})=>`${C.name}-${B.length}-${m.length}-${E.prop}-${h}`},{prop:"address",showOverflowTooltip:!0,label:"Address"}]),t=a({});return{data:o,columns:i,sort:t}}}}}(),"render-demo-14":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,createElementVNode:D,Fragment:f,openBlock:e,createElementBlock:n}=A,y={style:{"margin-bottom":"12px"}};function F(o,i){const t=r("xs-button"),E=r("xs-table");return e(),n(f,null,[D("div",y,[p(t,{type:"warning",onClick:i[0]||(i[0]=C=>o.addFilter("name",["Jerry"]))},{default:c(()=>[u("\u7B5B\u9009name=Jerry\u7684\u6570\u636E")]),_:1}),p(t,{type:"primary",onClick:i[1]||(i[1]=C=>o.addFilter("date",["2023-01-10","2023-01-15"]))},{default:c(()=>[u("\u5728Jerry\u57FA\u7840\u4E0A\u7B5B\u900901-10\u523001-15\u7684\u6570\u636E")]),_:1}),p(t,{type:"danger",onClick:o.clearFilter},{default:c(()=>[u("\u6E05\u7A7A\u7B5B\u9009")]),_:1},8,["onClick"])]),p(E,{ref:"tableRef",filter:o.filters,columns:o.columns,data:o.data},null,8,["filter","columns","data"])],64)}const{ref:a}=A;return{render:F,...{setup(){const o=a(Array.from({length:10}).map((m,h)=>({date:`2023-01-1${h}`,age:h*10+10,name:h%2===0?"Tom":"Jerry",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),i=a([{type:"index",width:60,label:"#",align:"center"},{prop:"date",label:"Date",sortable:!0,filterable:!0,filter:{type:"time"}},{prop:"name",label:"Name",filterable:!0,filter:{type:"select",multiple:!0},render:({column:m,row:h,rows:v,columns:_,$index:k})=>`${h.name}-${v.length}-${_.length}-${m.prop}-${k}`},{prop:"name",label:"Name",filterable:!0,filter:{type:"select"},render:({row:m})=>m.name},{prop:"age",label:"Age",filterable:!0,filter:{type:"number",suffixLabel:"\u5C81"}},{prop:"address",label:"Address",filterable:!0,showOverflowTooltip:!0}]),t=a({}),E=(m,h)=>{t.value[m]=h},C=a();return{data:o,filters:t,addFilter:E,clearFilter:()=>{t.value={},C.value.clearFilter()},columns:i,tableRef:C}}}}}(),"render-demo-15":function(){const{toDisplayString:u,createTextVNode:r,resolveComponent:c,withCtx:p,createVNode:D,openBlock:f,createBlock:e}=A;function n(a,d){const o=c("xs-button"),i=c("xs-table");return f(),e(i,{columns:a.columns,data:a.data},{ageLabel:p(({column:t})=>[D(o,{type:"primary",size:"small"},{default:p(()=>[r("slotLabel\u6E32\u67D3"+u(t.prop),1)]),_:2},1024)]),age:p(({row:t})=>[D(o,{type:"primary",size:"small"},{default:p(()=>[r("slot: "+u(t.age),1)]),_:2},1024)]),_:1},8,["columns","data"])}const{ref:y}=A;return{render:n,...{setup(){const a=y(Array.from({length:10}).map((o,i)=>({date:`2023-01-1${i}`,age:i+1,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),d=y([{type:"index",width:60,label:"#",align:"center"},{prop:"date",label:"Date",renderLabel:o=>"renderLabel\u51FD\u6570\u6E32\u67D3"+o.prop,render:({column:o,row:i})=>`render: ${i[o.prop]}`,sortable:!0},{prop:"age",label:"Age",slotLabel:"ageLabel",slot:"age",sortable:!0},{prop:"name",label:"Name",render:({column:o,row:i,rows:t,columns:E,$index:C})=>`${i.name}-${t.length}-${E.length}-${o.prop}-${C}`},{prop:"address",showOverflowTooltip:!0,label:"Address"}]);return{data:a,columns:d}}}}}(),"render-demo-16":function(){const{toDisplayString:u,createElementVNode:r,createTextVNode:c,resolveComponent:p,withCtx:D,openBlock:f,createBlock:e}=A,n=r("br",null,null,-1),y=r("br",null,null,-1),F=r("br",null,null,-1),a=r("br",null,null,-1);function d(t,E){const C=p("xs-table");return f(),e(C,{columns:t.columns,data:t.data},{expand:D(({row:B,column:m,rows:h,$index:v,columns:_})=>[c(" row = "+u(B)+" ",1),n,c(" column = "+u(m)+" ",1),y,c(" rows[2] = "+u(h[2])+" ",1),F,c(" columns[2] = "+u(_[2])+" ",1),a,c(" $index = "+u(v),1)]),_:1},8,["columns","data"])}const{ref:o}=A;return{render:d,...{setup(){const t=o(Array.from({length:10}).map((C,B)=>({date:`2023-01-1${B}`,age:B*10+10,name:B%2===0?"Tom":"Jerry",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),E=o([{type:"expand",width:60,label:"#",align:"center",slot:"expand"},{prop:"date",label:"Date",sortable:!0,filterable:!0,filter:{type:"time"}},{prop:"name",label:"Name",filterable:!0,render:({column:C,row:B,rows:m,columns:h,$index:v})=>`${B.name}-${m.length}-${h.length}-${C.prop}-${v}`},{prop:"age",label:"Age",filterable:!0,filter:{type:"number",suffixLabel:"\u5C81"}},{prop:"address",label:"Address",showOverflowTooltip:!0}]);return{data:t,columns:E}}}}}(),"render-demo-17":function(){const{resolveComponent:u,createVNode:r,Fragment:c,openBlock:p,createElementBlock:D}=A;function f(y,F){const a=u("xs-table");return p(),D(c,null,[r(a,{columns:y.columns,data:y.data,"row-key":"id"},null,8,["columns","data"]),r(a,{columns:y.columns,data:y.data2,"row-key":"id",lazy:"",load:y.load},null,8,["columns","data","load"])],64)}const{ref:e}=A;return{render:f,...{setup(){const y=e([{id:"1",date:"2016-05-02",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"},{id:"2",date:"2016-05-04",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"},{id:"3",date:"2016-05-01",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles",children:[{id:"31",date:"2016-06-01",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"},{id:"32",date:"2016-05-02",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"}]},{id:"4",date:"2016-05-03",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"}]),F=e([{id:"1",date:"2016-05-02",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"},{id:"2",date:"2016-05-04",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"},{id:"3",date:"2016-05-01",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles",hasChildren:!0},{id:"4",date:"2016-05-03",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"}]),a=e([{prop:"date",label:"Date"},{prop:"name",label:"Name"},{prop:"address",label:"Address"}]);return{data:y,load:(o,i,t)=>{setTimeout(()=>{t([{id:31,date:"2016-05-01",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"},{id:32,date:"2016-05-01",name:"wangxiaohu",address:"No. 189, Grove St, Los Angeles"}])},1e3)},data2:F,columns:a}}}}}(),"render-demo-18":function(){const{resolveComponent:u,createVNode:r,Fragment:c,openBlock:p,createElementBlock:D}=A;function f(y,F){const a=u("xs-table");return p(),D(c,null,[r(a,{columns:y.columns,data:y.data,"show-summary":""},null,8,["columns","data"]),r(a,{columns:y.columns,data:y.data,"show-summary":"","summary-method":y.getSummaries,"summary-position":"top"},null,8,["columns","data","summary-method"])],64)}const{ref:e}=A;return{render:f,...{setup(){const y=e(Array.from({length:10}).map((d,o)=>({date:`2023-01-1${o}`,age:o*10+10,name:o%2===0?"Tom":"Jerry",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),F=e([{prop:"date",label:"Date",sortable:!0,filterable:!0,filter:{type:"time"}},{prop:"name",label:"Name",filterable:!0,render:({column:d,row:o,rows:i,columns:t,$index:E})=>`${o.name}-${i.length}-${t.length}-${d.prop}-${E}`},{prop:"age",label:"Age",filterable:!0,filter:{type:"number",suffixLabel:"\u5C81"}},{prop:"address",label:"Address",showOverflowTooltip:!0}]);return{data:y,getSummaries:d=>{const{columns:o,data:i}=d,t=[];return o.forEach((E,C)=>{if(C===0){t[C]="Total Cost";return}const B=i.map(m=>Number(m[E.property]));B.every(m=>Number.isNaN(m))?t[C]="N/A":t[C]=`$ ${B.reduce((m,h)=>{const v=Number(h);return Number.isNaN(v)?m:m+h},0)}`}),t},columns:F}}}}}(),"render-demo-19":function(){const{resolveComponent:u,openBlock:r,createBlock:c}=A;function p(e,n){const y=u("xs-table");return r(),c(y,{columns:e.columns,"span-method":e.arraySpanMethod,data:e.data,border:""},null,8,["columns","span-method","data"])}const{ref:D}=A;return{render:p,...{setup(){const e=D(Array.from({length:10}).map((F,a)=>({date:`2023-01-1${a}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),n=D([{prop:"date",label:"Date"},{prop:"name",label:"Name"},{prop:"address",label:"Address"}]);return{data:e,columns:n,arraySpanMethod:({row:F,column:a,rowIndex:d,columnIndex:o})=>{if(d%2===0){if(o===0)return[1,2];if(o===1)return[0,0]}}}}}}}(),"render-demo-20":function(){const{resolveComponent:u,openBlock:r,createBlock:c}=A;function p(e,n){const y=u("xs-table");return r(),c(y,{columns:e.columns,data:e.data},null,8,["columns","data"])}const{ref:D}=A;return{render:p,...{setup(){const e=D(Array.from({length:5}).map((y,F)=>({date:`2023-01-1${F}`,name:"Tom",address:"No. 189, Grove St, Los Angeles"}))),n=D([{type:"index",index:y=>y*2},{prop:"date",label:"Date"},{prop:"name",label:"Name"},{prop:"address",label:"Address"}]);return{data:e,columns:n}}}}}(),"render-demo-21":function(){const{createTextVNode:u,resolveComponent:r,withCtx:c,createVNode:p,openBlock:D,createBlock:f}=A;function e(F,a){const d=r("xs-button"),o=r("xs-table");return D(),f(o,{stickyable:"",columns:F.columns,data:F.data,offset:73},{operations:c(()=>[p(d,{link:"",type:"danger",size:"small"},{default:c(()=>[u("\u5220\u9664")]),_:1})]),_:1},8,["columns","data"])}const{ref:n}=A;return{render:e,...{setup(){const F=n(Array.from({length:10}).map((d,o)=>({date:`2023-01-1${o}`,name:"Tom",state:"California",city:"Los Angeles",address:"No. 189, Grove St, Los Angeles",zip:"CA 90036",tag:"Office"}))),a=n([{prop:"date",label:"Date",width:100,fixed:!0},{prop:"name",label:"Name",width:200},{prop:"state",label:"State",width:200},{prop:"city",label:"City",width:200},{prop:"address",label:"Address",width:600},{slot:"operations",label:"Operations",width:120,fixed:"right"}]);return{data:F,columns:a}}}}}()}}),tl=JSON.parse('{"title":"Table \u8868\u683C","description":"","frontmatter":{},"headers":[],"relativePath":"components/table.md","lastUpdated":1675921010000}');const J=w('<h1 id="table-\u8868\u683C" tabindex="-1">Table \u8868\u683C</h1><p>\u7528\u4E8E\u5C55\u793A\u591A\u6761\u7ED3\u6784\u7C7B\u4F3C\u7684\u6570\u636E\uFF0C \u53EF\u5BF9\u6570\u636E\u8FDB\u884C\u6392\u5E8F\u3001\u7B5B\u9009\u3001\u5BF9\u6BD4\u6216\u5176\u4ED6\u81EA\u5B9A\u4E49\u64CD\u4F5C\u3002\u57FA\u4E8E <code>el-table</code> \u5C01\u88C5\u3002</p><div class="tip custom-block"><p class="custom-block-title">\u65B0\u7279\u6027</p><ol class="contains-task-list"><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u4F7F\u7528 JSON \u914D\u7F6E\u8868\u683C;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u652F\u6301\u5217\u7684 slot;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u5217\u652F\u6301\u81EA\u5B9A\u4E49 render \u51FD\u6570\uFF0C\u652F\u6301\u6E32\u67D3 jsx \u7247\u6BB5;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u652F\u6301\u81EA\u5B9A\u4E49\u8868\u5934\u7684 slot,</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u5217\u5934\u652F\u6301\u81EA\u5B9A\u4E49\u7684 renderLabel \u51FD\u6570\uFF0C\u4E5F\u652F\u6301\u6E32\u67D3 jsx \u7247\u6BB5\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u8868\u683C\u5438\u9876\uFF0C\u652F\u6301\u914D\u7F6E\u5438\u9876\u7684\u504F\u79FB\u91CF\uFF0C\u540C\u65F6\u6A2A\u5411\u6EDA\u52A8\u6761\u5438\u5E95\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u6591\u9A6C\u7EB9\u652F\u6301\u8D77\u59CB\u884C\u53F7\u914D\u7F6E\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u9AA8\u67B6\u5C4F\u52A0\u8F7D, \u652F\u6301\u914D\u7F6E\u9AA8\u67B6\u5C4F\u884C\u6570\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u81EA\u5E26\u5206\u9875\uFF0C\u652F\u6301\u5173\u95ED\u548C\u8C03\u6574\u5206\u9875\u5E03\u5C40\u548C\u53C2\u6570;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u5168\u91CF\u6570\u636E\u6392\u5E8F\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u5168\u91CF\u6570\u636E\u7B5B\u9009\uFF0C\u652F\u6301\u6570\u636E\u8303\u56F4\uFF0C\u6587\u672C\u8F93\u5165\uFF0C\u65F6\u95F4\u9009\u62E9\uFF0C\u4E0B\u62C9\u591A\u9009\u7684\u7B5B\u9009\u6A21\u5F0F;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u652F\u6301\u8868\u683C\u5916\u90E8\u63A7\u5236\u8868\u683C\u7684\u6392\u5E8F\u548C\u7B5B\u9009;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u8868\u5934\u989C\u8272\u4E3B\u9898\u8272\u914D\u7F6E\u548C\u81EA\u5B9A\u4E49\u989C\u8272\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u652F\u6301\u5206\u7EC4\u548C\u5206\u7EC4\u7684 EmptySlot \u81EA\u5B9A\u4E49;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u5408\u8BA1\u884C\u652F\u6301\u4F4D\u7F6E\u8C03\u6574\uFF1B</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u6570\u5B57\u683C\u5F0F\u5316,\u652F\u6301\u683C\u5F0F\u4E0E\u5C0F\u6570\u4F4D\u6570\u7684\u81EA\u5B9A\u4E49;</li><li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox"> \u5355\u9009\u8C03\u6574</li><li class="task-list-item"><input class="task-list-item-checkbox" disabled="" type="checkbox"> <s>\u8DE8\u9875\u591A\u9009\u652F\u6301</s></li></ol></div><h2 id="\u57FA\u7840\u8868\u683C" tabindex="-1">\u57FA\u7840\u8868\u683C</h2><p>\u57FA\u7840\u7684\u8868\u683C\u5C55\u793A\u7528\u6CD5\u3002</p><p>\u5F53 <code>xs-table</code> \u5143\u7D20\u4E2D\u6CE8\u5165 <code>data</code> \u548C <code>columns</code> \u5BF9\u8C61\u6570\u7EC4\u540E\uFF0C\u5728 <code>column</code> \u4E2D\u7528 <code>prop</code> \u5C5E\u6027\u6765\u5BF9\u5E94\u5BF9\u8C61\u4E2D\u7684\u952E\u540D\u5373\u53EF\u586B\u5165\u6570\u636E\uFF0C\u7528 <code>label</code> \u5C5E\u6027\u6765\u5B9A\u4E49\u8868\u683C\u7684\u5217\u540D\u3002 \u53EF\u4EE5\u4F7F\u7528 <code>width</code> \u5C5E\u6027\u6765\u5B9A\u4E49\u5217\u5BBD\u3002\u524D\u7AEF\u5206\u9875\u9ED8\u8BA4\u5F00\u542F\u3002</p>',6),P=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),j=s("h2",{id:"loading-\u52A0\u8F7D",tabindex:"-1"},"Loading \u52A0\u8F7D",-1),M=s("p",null,[l("\u4F20\u5165 "),s("code",null,"loading"),l(" \u5C5E\u6027\u5373\u53EF\u63A7\u5236\u8868\u683C\u662F\u5426\u5904\u4E8E\u52A0\u8F7D\u72B6\u6001\u3002\u8FD8\u53EF\u4EE5\u901A\u8FC7\u8BBE\u7F6E "),s("code",null,"skeleton-rows"),l(" \u914D\u7F6E\u9AA8\u67B6\u5C4F\u884C\u6570\uFF0C \u9ED8\u8BA4\u4E3A 20 \u884C\u3002")],-1),q=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Z=s("h2",{id:"\u5206\u9875",tabindex:"-1"},"\u5206\u9875",-1),Y=s("p",null,"\u5982\u679C\u4F60\u9700\u8981\u540E\u7AEF\u5206\u9875\u65F6\uFF0C\u4F60\u53EF\u4EE5\u5173\u95ED\u7EC4\u4EF6\u5185\u7684\u5206\u9875\u3002",-1),H=s("p",null,"\u6216\u8005\u8C03\u6574\u4E00\u4E0B\u5206\u9875\u7684\u53C2\u6570\u4E5F\u662F\u53EF\u4EE5\u7684\u3002",-1),X=s("p",null,"\u5206\u9875\u5185\u6709 2 \u4E2A\u63D2\u69FD\u63D0\u4F9B\u3002",-1),U=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),W=s("h2",{id:"\u6591\u9A6C\u7EB9\u8868\u683C",tabindex:"-1"},"\u6591\u9A6C\u7EB9\u8868\u683C",-1),K=s("p",null,[s("code",null,"stripe"),l(" \u53EF\u4EE5\u521B\u5EFA\u5E26\u6591\u9A6C\u7EB9\u7684\u8868\u683C\u3002 \u5982\u679C "),s("code",null,"true"),l(", \u8868\u683C\u5C06\u4F1A\u5E26\u6709\u6591\u9A6C\u7EB9\u3002")],-1),Q=s("p",null,"\u6591\u9A6C\u7EB9\u9ED8\u8BA4\u5F00\u542F\u3002\u5982\u679C\u4E0D\u9700\u8981\uFF0C\u53EF\u4EE5\u624B\u52A8\u5173\u95ED\u3002",-1),ss=s("p",null,"\u5728\u8BBE\u8BA1\u56FE\u4E2D\uFF0C\u5982\u679C\u8868\u5934\u5E26\u6709\u80CC\u666F\u8272\uFF0C\u5219\u6591\u9A6C\u7EB9\u662F\u4ECE\u7B2C\u4E8C\u884C\u5F00\u59CB\u7684\u3002",-1),ls=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),os=s("h2",{id:"\u5E26\u8FB9\u6846\u8868\u683C",tabindex:"-1"},"\u5E26\u8FB9\u6846\u8868\u683C",-1),ns=s("p",null,[l("\u9ED8\u8BA4\u60C5\u51B5\u4E0B\uFF0CTable \u7EC4\u4EF6\u662F\u4E0D\u5177\u6709\u7AD6\u76F4\u65B9\u5411\u7684\u8FB9\u6846\u7684\uFF0C \u5982\u679C\u9700\u8981\uFF0C\u53EF\u4EE5\u4F7F\u7528 "),s("code",null,"border"),l(" \u5C5E\u6027\uFF0C\u628A\u8BE5\u5C5E\u6027\u8BBE\u7F6E\u4E3A "),s("code",null,"true"),l(" \u5373\u53EF\u542F\u7528\u3002")],-1),es=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),as=s("h2",{id:"\u5E26\u72B6\u6001\u8868\u683C",tabindex:"-1"},"\u5E26\u72B6\u6001\u8868\u683C",-1),ts=s("p",null,"\u53EF\u5C06\u8868\u683C\u5185\u5BB9 highlight \u663E\u793A\uFF0C\u65B9\u4FBF\u533A\u5206\u300C\u6210\u529F\u3001\u4FE1\u606F\u3001\u8B66\u544A\u3001\u5371\u9669\u300D\u7B49\u5185\u5BB9\u3002",-1),ps=s("p",null,[l("\u53EF\u4EE5\u901A\u8FC7\u6307\u5B9A Table \u7EC4\u4EF6\u7684 "),s("code",null,"row-class-name"),l(" \u5C5E\u6027\u6765\u4E3A Table \u4E2D\u7684\u67D0\u4E00\u884C\u6DFB\u52A0 class\uFF0C \u8FD9\u6837\u5C31\u53EF\u4EE5\u81EA\u5B9A\u4E49\u6BCF\u4E00\u884C\u7684\u6837\u5F0F\u4E86\u3002")],-1),cs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"style"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),rs=s("h2",{id:"\u56FA\u5B9A\u8868\u5934",tabindex:"-1"},"\u56FA\u5B9A\u8868\u5934",-1),ys=s("p",null,"\u7EB5\u5411\u5185\u5BB9\u8FC7\u591A\u65F6\uFF0C\u53EF\u9009\u62E9\u56FA\u5B9A\u8868\u5934\u3002",-1),Fs=s("p",null,"\u53EA\u8981\u5728\u5143\u7D20\u4E2D\u5B9A\u4E49\u4E86 height \u5C5E\u6027\uFF0C\u5373\u53EF\u5B9E\u73B0\u56FA\u5B9A\u8868\u5934\u7684\u8868\u683C\uFF0C\u800C\u4E0D\u9700\u8981\u989D\u5916\u7684\u4EE3\u7801\u3002",-1),Ds=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Cs=s("h2",{id:"\u56FA\u5B9A\u5217\u548C\u8868\u5934",tabindex:"-1"},"\u56FA\u5B9A\u5217\u548C\u8868\u5934",-1),ds=s("p",null,[l("\u56FA\u5B9A\u5217\u548C\u8868\u5934\u53EF\u4EE5\u540C\u65F6\u4F7F\u7528\uFF0C\u53EA\u9700\u8981\u5C06\u4E0A\u8FF0\u4E24\u4E2A\u5C5E\u6027("),s("code",null,"fixed"),l(", "),s("code",null,"height"),l(")\u5206\u522B\u8BBE\u7F6E\u597D\u5373\u53EF\u3002\u672C\u7AE0\u8282\u65E0 demo;")],-1),As=s("h2",{id:"\u6D41\u4F53\u9AD8\u5EA6",tabindex:"-1"},"\u6D41\u4F53\u9AD8\u5EA6",-1),Es=s("p",null,"\u5F53\u6570\u636E\u91CF\u52A8\u6001\u53D8\u5316\u65F6\uFF0C\u53EF\u4EE5\u4E3A Table \u8BBE\u7F6E\u4E00\u4E2A\u6700\u5927\u9AD8\u5EA6\u3002",-1),ms=s("p",null,[l("\u901A\u8FC7\u8BBE\u7F6E "),s("code",null,"max-height"),l(" \u5C5E\u6027\u6307\u5B9A\u6700\u5927\u9AD8\u5EA6\u3002 \u6B64\u65F6\u82E5\u8868\u683C\u6240\u9700\u7684\u9AD8\u5EA6\u5927\u4E8E\u6700\u5927\u9AD8\u5EA6\uFF0C\u5219\u4F1A\u663E\u793A\u4E00\u4E2A\u6EDA\u52A8\u6761")],-1),gs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),bs=w('<h2 id="\u591A\u7EA7\u8868\u5934" tabindex="-1">\u591A\u7EA7\u8868\u5934</h2><p>\u6570\u636E\u7ED3\u6784\u6BD4\u8F83\u590D\u6742\u7684\u65F6\u5019\uFF0C\u53EF\u4F7F\u7528\u591A\u7EA7\u8868\u5934\u6765\u5C55\u73B0\u6570\u636E\u7684\u5C42\u6B21\u5173\u7CFB\u3002</p><p>\u53EA\u9700\u8981\u5C06 <code>columnItem</code> \u6DFB\u52A0\u4E00\u4E2A <code>children</code> \u5B57\u6BB5\uFF0C\u5E76\u653E\u5165\u5B50\u96C6 <code>columnItem</code> \u4F60\u53EF\u4EE5\u5B9E\u73B0\u7EC4\u5934\u3002</p><p>\u8FD9\u91CC\u8FD8\u4F7F\u7528\u4E86 <code>align</code> \u548C <code>showOverflowTooltip</code> \u5C5E\u6027\u3002</p>',4),fs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  <"),s("span",{style:{color:"#7EE787"}},"xs-table"),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"columns"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"columns"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"data"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"data"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"    <"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}}," #"),s("span",{style:{color:"#79C0FF"}},"operations"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      <"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"link"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"type"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"danger"'),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"size"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"small"'),s("span",{style:{color:"#C9D1D9"}},">\u5220\u9664</"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"    </"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Bs=s("h2",{id:"\u8868\u5934\u989C\u8272\u81EA\u5B9A\u4E49",tabindex:"-1"},"\u8868\u5934\u989C\u8272\u81EA\u5B9A\u4E49",-1),hs=s("p",null,[l("\u5728 "),s("code",null,"column"),l(" \u8BBE\u7F6E "),s("code",null,"background"),l(" \u5373\u53EF, \u591A\u7EA7\u8868\u5934\u7684\u5B50\u96C6\u5982\u679C\u6CA1\u6709\u5B9A\u4E49\u80CC\u666F\u8272\u5219\u7EE7\u627F\u4E0A\u7EA7\u3002")],-1),xs=s("p",null,[l("\u5982\u679C Table \u4F20\u5165\u4E86 "),s("code",null,"theme-color"),l(", \u4F18\u5148\u663E\u793A\u3002")],-1),vs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),ws=s("h2",{id:"\u591A\u9009",tabindex:"-1"},"\u591A\u9009",-1),_s=s("p",null,"\u4F60\u53EF\u4EE5\u9009\u62E9\u591A\u884C\u3002",-1),ks=s("p",null,"\u5B9E\u73B0\u591A\u9009\u975E\u5E38\u7B80\u5355: \u624B\u52A8\u6DFB\u52A0\u4E00\u4E2A column\uFF0C\u8BBE type \u5C5E\u6027\u4E3A selection \u5373\u53EF\uFF1B",-1),Ns=s("p",null,[l("\u6B64\u5916, \u8FD8\u5F00\u542F\u4E86 "),s("code",null,"type = index"),l(" \u7684\u5E8F\u53F7\u5217\u3002")],-1),$s=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  <"),s("span",{style:{color:"#7EE787"}},"xs-table"),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"columns"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"columns"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"data"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"data"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"    <"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}}," #"),s("span",{style:{color:"#79C0FF"}},"operations"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      <"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"link"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"type"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"danger"'),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"size"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"small"'),s("span",{style:{color:"#C9D1D9"}},">\u5220\u9664</"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"    </"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Ls=w('<h2 id="\u5355\u9009" tabindex="-1">\u5355\u9009</h2><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>\u672C\u8868\u683C\u7684\u5355\u9009\u4E0E <code>el-table</code> \u7684\u5355\u9009\u4F7F\u7528\u65B9\u5F0F\u7565\u6709\u4E0D\u540C\u3002\u5177\u4F53\u8BF7\u770B demo\u3002</p></div><p>\u9009\u62E9\u5355\u884C\u6570\u636E\u65F6\u4F7F\u7528\u8272\u5757\u8868\u793A\u3002</p><p>Table \u7EC4\u4EF6\u63D0\u4F9B\u4E86\u5355\u9009\u7684\u652F\u6301\uFF0C \u53EA\u9700\u8981\u914D\u7F6E <code>highlight-current-row</code> \u5C5E\u6027\u5373\u53EF\u5B9E\u73B0\u5355\u9009\u3002 \u4E4B\u540E\u7531 <code>current-change</code> \u4E8B\u4EF6\u6765\u7BA1\u7406\u9009\u4E2D\u65F6\u89E6\u53D1\u7684\u4E8B\u4EF6\uFF0C\u5B83\u4F1A\u4F20\u5165 <code>{ currentRow, oldCurrentRow, currentRowIndex, oldCurrentIndex }</code>\u3002</p>',4),Ss=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  <"),s("span",{style:{color:"#7EE787"}},"div"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"style"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"margin-bottom:12px;"'),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"    <"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"type"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"warning"'),s("span",{style:{color:"#C9D1D9"}}," @"),s("span",{style:{color:"#79C0FF"}},"click"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#D2A8FF"}},"onClick"),s("span",{style:{color:"#C9D1D9"}},"("),s("span",{style:{color:"#79C0FF"}},"2"),s("span",{style:{color:"#C9D1D9"}},")"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">\u9009\u4E2D\u7B2C\u4E09\u884C</"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"    <"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"type"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"primary"'),s("span",{style:{color:"#C9D1D9"}}," @"),s("span",{style:{color:"#79C0FF"}},"click"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"onClick"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">\u6E05\u9664\u9009\u4E2D</"),s("span",{style:{color:"#7EE787"}},"xs-button"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  </"),s("span",{style:{color:"#7EE787"}},"div"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  <"),s("span",{style:{color:"#7EE787"}},"xs-table"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"ref"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#A5D6FF"}},'"tableRef"'),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"columns"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"columns"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"data"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"data"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"highlight-current-row"),s("span",{style:{color:"#C9D1D9"}}," @"),s("span",{style:{color:"#79C0FF"}},"current-change"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"onCurrentChange"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  </"),s("span",{style:{color:"#7EE787"}},"xs-table"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"</"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"script"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  "),s("span",{style:{color:"#FF7B72"}},"import"),s("span",{style:{color:"#C9D1D9"}}," { ref } "),s("span",{style:{color:"#FF7B72"}},"from"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#A5D6FF"}},"'vue'"),s("span",{style:{color:"#C9D1D9"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  "),s("span",{style:{color:"#FF7B72"}},"export"),s("span",{style:{color:"#FFA657"}}," "),s("span",{style:{color:"#FF7B72"}},"default"),s("span",{style:{color:"#FFA657"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#FFA657"}},"    "),s("span",{style:{color:"#D2A8FF"}},"setup"),s("span",{style:{color:"#FFA657"}},"() "),s("span",{style:{color:"#C9D1D9"}},"{")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      "),s("span",{style:{color:"#FF7B72"}},"const"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"tableRef"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"="),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#D2A8FF"}},"ref"),s("span",{style:{color:"#C9D1D9"}},"("),s("span",{style:{color:"#79C0FF"}},"null"),s("span",{style:{color:"#C9D1D9"}},");")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      "),s("span",{style:{color:"#FF7B72"}},"const"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#79C0FF"}},"data"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"="),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#D2A8FF"}},"ref"),s("span",{style:{color:"#C9D1D9"}},"(")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"        Array."),s("span",{style:{color:"#D2A8FF"}},"from"),s("span",{style:{color:"#C9D1D9"}},"({ length: "),s("span",{style:{color:"#79C0FF"}},"10"),s("span",{style:{color:"#C9D1D9"}}," })."),s("span",{style:{color:"#D2A8FF"}},"map"),s("span",{style:{color:"#C9D1D9"}},"(("),s("span",{style:{color:"#FFA657"}},"_"),s("span",{style:{color:"#C9D1D9"}},", "),s("span",{style:{color:"#FFA657"}},"index"),s("span",{style:{color:"#C9D1D9"}},") "),s("span",{style:{color:"#FF7B72"}},"=>"),s("span",{style:{color:"#C9D1D9"}}," ({")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"          date: "),s("span",{style:{color:"#A5D6FF"}},"`2023-01-1${"),s("span",{style:{color:"#C9D1D9"}},"index"),s("span",{style:{color:"#A5D6FF"}},"}`"),s("span",{style:{color:"#C9D1D9"}},",")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      ]);")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      "),s("span",{style:{color:"#FF7B72"}},"const"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#D2A8FF"}},"onClick"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"="),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FFA657"}},"rowIndex"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"=>"),s("span",{style:{color:"#C9D1D9"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"        tableRef.value."),s("span",{style:{color:"#D2A8FF"}},"setCurrentRow"),s("span",{style:{color:"#C9D1D9"}},"(rowIndex);")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      };")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      "),s("span",{style:{color:"#FF7B72"}},"const"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#D2A8FF"}},"onCurrentChange"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"="),s("span",{style:{color:"#C9D1D9"}}," ({ "),s("span",{style:{color:"#FFA657"}},"currentRowIndex"),s("span",{style:{color:"#C9D1D9"}}," }) "),s("span",{style:{color:"#FF7B72"}},"=>"),s("span",{style:{color:"#C9D1D9"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"        "),s("span",{style:{color:"#D2A8FF"}},"alert"),s("span",{style:{color:"#C9D1D9"}},"(currentRowIndex "),s("span",{style:{color:"#FF7B72"}},"==="),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"-"),s("span",{style:{color:"#79C0FF"}},"1"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},"?"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#A5D6FF"}},"'\u53D6\u6D88\u5355\u9009'"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#FF7B72"}},":"),s("span",{style:{color:"#C9D1D9"}}," "),s("span",{style:{color:"#A5D6FF"}},"`\u9009\u4E2D\u4E86\u7B2C${"),s("span",{style:{color:"#C9D1D9"}},"currentRowIndex"),s("span",{style:{color:"#A5D6FF"}}," "),s("span",{style:{color:"#FF7B72"}},"+"),s("span",{style:{color:"#A5D6FF"}}," "),s("span",{style:{color:"#79C0FF"}},"1"),s("span",{style:{color:"#A5D6FF"}},"}\u884C`"),s("span",{style:{color:"#C9D1D9"}},");")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      };")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"      "),s("span",{style:{color:"#FF7B72"}},"return"),s("span",{style:{color:"#C9D1D9"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"        data,")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"        columns,")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"        onCurrentChange,")]),l(`
...
`),s("span",{class:"line"})])]),s("pre",{"v-pre":"",class:"shiki vp-code-light"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"<"),s("span",{style:{color:"#116329"}},"template"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  <"),s("span",{style:{color:"#116329"}},"div"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"style"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#0A3069"}},'"margin-bottom:12px;"'),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"    <"),s("span",{style:{color:"#116329"}},"xs-button"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"type"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#0A3069"}},'"warning"'),s("span",{style:{color:"#24292F"}}," @"),s("span",{style:{color:"#0550AE"}},"click"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#8250DF"}},"onClick"),s("span",{style:{color:"#24292F"}},"("),s("span",{style:{color:"#0550AE"}},"2"),s("span",{style:{color:"#24292F"}},")"),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},">\u9009\u4E2D\u7B2C\u4E09\u884C</"),s("span",{style:{color:"#116329"}},"xs-button"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"    <"),s("span",{style:{color:"#116329"}},"xs-button"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"type"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#0A3069"}},'"primary"'),s("span",{style:{color:"#24292F"}}," @"),s("span",{style:{color:"#0550AE"}},"click"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},"onClick"),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},">\u6E05\u9664\u9009\u4E2D</"),s("span",{style:{color:"#116329"}},"xs-button"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  </"),s("span",{style:{color:"#116329"}},"div"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  <"),s("span",{style:{color:"#116329"}},"xs-table"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"ref"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#0A3069"}},'"tableRef"'),s("span",{style:{color:"#24292F"}}," :"),s("span",{style:{color:"#0550AE"}},"columns"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},"columns"),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}}," :"),s("span",{style:{color:"#0550AE"}},"data"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},"data"),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"highlight-current-row"),s("span",{style:{color:"#24292F"}}," @"),s("span",{style:{color:"#0550AE"}},"current-change"),s("span",{style:{color:"#24292F"}},"="),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},"onCurrentChange"),s("span",{style:{color:"#24292F"}},'"'),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  </"),s("span",{style:{color:"#116329"}},"xs-table"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"template"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"<"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  "),s("span",{style:{color:"#CF222E"}},"import"),s("span",{style:{color:"#24292F"}}," { ref } "),s("span",{style:{color:"#CF222E"}},"from"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0A3069"}},"'vue'"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"  "),s("span",{style:{color:"#CF222E"}},"export"),s("span",{style:{color:"#953800"}}," "),s("span",{style:{color:"#CF222E"}},"default"),s("span",{style:{color:"#953800"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"    "),s("span",{style:{color:"#8250DF"}},"setup"),s("span",{style:{color:"#953800"}},"() "),s("span",{style:{color:"#24292F"}},"{")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      "),s("span",{style:{color:"#CF222E"}},"const"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"tableRef"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"="),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#8250DF"}},"ref"),s("span",{style:{color:"#24292F"}},"("),s("span",{style:{color:"#0550AE"}},"null"),s("span",{style:{color:"#24292F"}},");")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      "),s("span",{style:{color:"#CF222E"}},"const"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0550AE"}},"data"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"="),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#8250DF"}},"ref"),s("span",{style:{color:"#24292F"}},"(")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"        Array."),s("span",{style:{color:"#8250DF"}},"from"),s("span",{style:{color:"#24292F"}},"({ length: "),s("span",{style:{color:"#0550AE"}},"10"),s("span",{style:{color:"#24292F"}}," })."),s("span",{style:{color:"#8250DF"}},"map"),s("span",{style:{color:"#24292F"}},"(("),s("span",{style:{color:"#953800"}},"_"),s("span",{style:{color:"#24292F"}},", "),s("span",{style:{color:"#953800"}},"index"),s("span",{style:{color:"#24292F"}},") "),s("span",{style:{color:"#CF222E"}},"=>"),s("span",{style:{color:"#24292F"}}," ({")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"          date: "),s("span",{style:{color:"#0A3069"}},"`2023-01-1${"),s("span",{style:{color:"#24292F"}},"index"),s("span",{style:{color:"#0A3069"}},"}`"),s("span",{style:{color:"#24292F"}},",")]),l(`
...
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      "),s("span",{style:{color:"#CF222E"}},"const"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#8250DF"}},"onClick"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"="),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#953800"}},"rowIndex"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"=>"),s("span",{style:{color:"#24292F"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"        tableRef.value."),s("span",{style:{color:"#8250DF"}},"setCurrentRow"),s("span",{style:{color:"#24292F"}},"(rowIndex);")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      };")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      "),s("span",{style:{color:"#CF222E"}},"const"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#8250DF"}},"onCurrentChange"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"="),s("span",{style:{color:"#24292F"}}," ({ "),s("span",{style:{color:"#953800"}},"currentRowIndex"),s("span",{style:{color:"#24292F"}}," }) "),s("span",{style:{color:"#CF222E"}},"=>"),s("span",{style:{color:"#24292F"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"        "),s("span",{style:{color:"#8250DF"}},"alert"),s("span",{style:{color:"#24292F"}},"(currentRowIndex "),s("span",{style:{color:"#CF222E"}},"==="),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"-"),s("span",{style:{color:"#0550AE"}},"1"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},"?"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0A3069"}},"'\u53D6\u6D88\u5355\u9009'"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#CF222E"}},":"),s("span",{style:{color:"#24292F"}}," "),s("span",{style:{color:"#0A3069"}},"`\u9009\u4E2D\u4E86\u7B2C${"),s("span",{style:{color:"#24292F"}},"currentRowIndex"),s("span",{style:{color:"#0A3069"}}," "),s("span",{style:{color:"#CF222E"}},"+"),s("span",{style:{color:"#0A3069"}}," "),s("span",{style:{color:"#0550AE"}},"1"),s("span",{style:{color:"#0A3069"}},"}\u884C`"),s("span",{style:{color:"#24292F"}},");")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      };")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"      "),s("span",{style:{color:"#CF222E"}},"return"),s("span",{style:{color:"#24292F"}}," {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"        data,")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Os=w('<h2 id="\u81EA\u5B9A\u4E49\u5217\u6A21\u677F\u548C\u81EA\u5B9A\u4E49\u8868\u5934" tabindex="-1">\u81EA\u5B9A\u4E49\u5217\u6A21\u677F\u548C\u81EA\u5B9A\u4E49\u8868\u5934</h2><p>\u81EA\u5B9A\u4E49\u5217\u7684\u663E\u793A\u5185\u5BB9\uFF0C\u53EF\u7EC4\u5408\u5176\u4ED6\u7EC4\u4EF6\u4F7F\u7528\uFF0C\u9700\u8981\u5728 <code>column</code> \u5185\u90E8\u6307\u5B9A <code>slot</code> \u5B57\u6BB5 \u6216 <code>render</code> \u51FD\u6570, \u63A5\u53D7 <code>{ row, rows, column, columns, $index }</code> \u4E3A\u53C2\u6570\u3002</p><p>\u81EA\u5B9A\u4E49\u8868\u5934\u7684\u663E\u793A\u5185\u5BB9\uFF0C\u9700\u8981\u5728 <code>column</code> \u5185\u6307\u5B9A <code>slotLabel</code> \u5B57\u6BB5\u6216 <code>renderLabel</code> \u51FD\u6570\uFF0C \u63A5\u6536 <code>column</code> \u4F5C\u4E3A\u53C2\u6570\u3002</p>',3),Rs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  <"),s("span",{style:{color:"#7EE787"}},"xs-table"),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"columns"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"columns"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"data"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"data"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Is=s("h2",{id:"\u5C55\u5F00\u884C",tabindex:"-1"},"\u5C55\u5F00\u884C",-1),Js=s("p",null,"\u5F53\u884C\u5185\u5BB9\u8FC7\u591A\u5E76\u4E14\u4E0D\u60F3\u663E\u793A\u6A2A\u5411\u6EDA\u52A8\u6761\u65F6\uFF0C\u53EF\u4EE5\u4F7F\u7528 Table \u5C55\u5F00\u884C\u529F\u80FD\u3002",-1),Ps=s("p",null,'\u901A\u8FC7\u8BBE\u7F6E type="expand" \u548C slot \u53EF\u4EE5\u5F00\u542F\u5C55\u5F00\u884C\u529F\u80FD\uFF0C \u6A21\u677F\u4F1A\u88AB\u6E32\u67D3\u6210\u4E3A\u5C55\u5F00\u884C\u7684\u5185\u5BB9\uFF0C\u5C55\u5F00\u884C\u53EF\u8BBF\u95EE\u7684\u5C5E\u6027\u4E0E\u4F7F\u7528\u81EA\u5B9A\u4E49\u5217\u6A21\u677F\u65F6\u7684 slot \u76F8\u540C\u3002',-1),js=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"  <"),s("span",{style:{color:"#7EE787"}},"xs-table"),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"columns"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"columns"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}}," :"),s("span",{style:{color:"#79C0FF"}},"data"),s("span",{style:{color:"#C9D1D9"}},"="),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},"data"),s("span",{style:{color:"#C9D1D9"}},'"'),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Ms=w('<h2 id="\u6811\u5F62\u6570\u636E\u4E0E\u61D2\u52A0\u8F7D" tabindex="-1">\u6811\u5F62\u6570\u636E\u4E0E\u61D2\u52A0\u8F7D</h2><p>\u652F\u6301\u6811\u7C7B\u578B\u7684\u6570\u636E\u7684\u663E\u793A\u3002 \u5F53 row \u4E2D\u5305\u542B <code>children</code> \u5B57\u6BB5\u65F6\uFF0C\u88AB\u89C6\u4E3A\u6811\u5F62\u6570\u636E\u3002 \u6E32\u67D3\u5D4C\u5957\u6570\u636E\u9700\u8981 prop \u7684 <code>row-key</code>\u3002 \u6B64\u5916\uFF0C\u5B50\u884C\u6570\u636E\u53EF\u4EE5\u5F02\u6B65\u52A0\u8F7D\u3002 \u8BBE\u7F6E Table \u7684 <code>lazy</code> \u5C5E\u6027\u4E3A <code>true</code> \u4E0E\u52A0\u8F7D\u51FD\u6570 <code>load</code> \u3002 \u901A\u8FC7\u6307\u5B9A row \u4E2D\u7684 <code>hasChildren</code> \u5B57\u6BB5\u6765\u6307\u5B9A\u54EA\u4E9B\u884C\u662F\u5305\u542B\u5B50\u8282\u70B9\u3002 <code>children</code> \u4E0E <code>hasChildren</code> \u90FD\u53EF\u4EE5\u901A\u8FC7 <code>tree-props</code> \u914D\u7F6E\u3002</p>',2),qs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Zs=w('<h2 id="\u5408\u8BA1\u884C" tabindex="-1">\u5408\u8BA1\u884C</h2><p>\u901A\u8FC7 <code>show-summary</code> \u6253\u5F00\u8868\u683C\u5408\u8BA1, <code>sum-text</code> \u9ED8\u8BA4\u4E3A <code>&quot;\u5408\u8BA1&quot;</code>\u3002</p><p>\u82E5\u8868\u683C\u5C55\u793A\u7684\u662F\u5404\u7C7B\u6570\u5B57\uFF0C\u53EF\u4EE5\u5728\u663E\u793A\u5404\u5217\u7684\u5408\u8BA1\u3002\u53EF\u4EE5\u901A\u8FC7 <code>summary-position</code> \u914D\u7F6E \u5408\u8BA1\u884C\u7684\u4F4D\u7F6E\uFF0C \u9ED8\u8BA4\u4E3A <code>bottom</code>\u3002</p><p>\u5982\u679C\u9700\u8981\u81EA\u5B9A\u4E49\u6C47\u603B\u6570\u636E\uFF0C\u8BF7\u4F20\u5165\u4E00\u4E2A <code>summary-method</code>, \u53C2\u6570\u4E3A <code>{ columns, data }</code>\u3002</p>',4),Ys=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),Hs=w('<h2 id="\u5408\u5E76\u884C\u6216\u5217" tabindex="-1">\u5408\u5E76\u884C\u6216\u5217</h2><p>\u591A\u884C\u6216\u591A\u5217\u5171\u7528\u4E00\u4E2A\u6570\u636E\u65F6\uFF0C\u53EF\u4EE5\u5408\u5E76\u884C\u6216\u5217\u3002</p><p>\u901A\u8FC7\u7ED9 table \u4F20\u5165<code>span-method</code>\u65B9\u6CD5\u53EF\u4EE5\u5B9E\u73B0\u5408\u5E76\u884C\u6216\u5217\uFF0C \u65B9\u6CD5\u7684\u53C2\u6570\u662F\u4E00\u4E2A\u5BF9\u8C61\uFF0C\u91CC\u9762\u5305\u542B\u5F53\u524D\u884C <code>row</code>\u3001\u5F53\u524D\u5217 <code>column</code>\u3001\u5F53\u524D\u884C\u53F7 <code>rowIndex</code>\u3001\u5F53\u524D\u5217\u53F7 <code>columnIndex</code> \u56DB\u4E2A\u5C5E\u6027\u3002 \u8BE5\u51FD\u6570\u53EF\u4EE5\u8FD4\u56DE\u4E00\u4E2A\u5305\u542B\u4E24\u4E2A\u5143\u7D20\u7684\u6570\u7EC4\uFF0C\u7B2C\u4E00\u4E2A\u5143\u7D20\u4EE3\u8868 <code>rowspan</code>\uFF0C\u7B2C\u4E8C\u4E2A\u5143\u7D20\u4EE3\u8868 <code>colspan</code>\u3002 \u4E5F\u53EF\u4EE5\u8FD4\u56DE\u4E00\u4E2A\u952E\u540D\u4E3A <code>rowspan</code> \u548C <code>colspan</code> \u7684\u5BF9\u8C61\u3002</p>',3),Xs=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#953800"}},"  }"),s("span",{style:{color:"#24292F"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292F"}},"</"),s("span",{style:{color:"#116329"}},"script"),s("span",{style:{color:"#24292F"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),sl=s("h2",{id:"\u8868\u5934\u5438\u9876\u548C\u6A2A\u5411\u6EDA\u52A8\u6761\u5438\u5E95",tabindex:"-1"},"\u8868\u5934\u5438\u9876\u548C\u6A2A\u5411\u6EDA\u52A8\u6761\u5438\u5E95",-1),ll=s("p",null,[l("\u901A\u8FC7\u5C5E\u6027 "),s("code",null,"stickyable"),l(" \u53EF\u4EE5\u6307\u5B9A\u8868\u683C\u8868\u5934\u662F\u5426\u5438\u9876\uFF0C\u6A2A\u5411\u6EDA\u52A8\u6761\u662F\u5426\u5438\u5E95\u3002\u8FD8\u53EF\u4EE5\u901A\u8FC7 "),s("code",null,"offset"),l("\u5C5E\u6027\u914D\u7F6E\u8DDD\u79BB\u89C6\u53E3\u9876\u90E8\u7684\u504F\u79FB\u91CF\u3002 \u9ED8\u8BA4\u5438\u9876\u5173\u95ED\u7684\u3002")],-1),ol=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),l(`
...
<\/script>
`},{highlight:b(()=>[P]),default:b(()=>[g(e)]),_:1}),j,M,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[q]),default:b(()=>[g(y)]),_:1}),Z,Y,H,X,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[U]),default:b(()=>[g(F)]),_:1}),W,K,Q,ss,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[ls]),default:b(()=>[g(a)]),_:1}),os,ns,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[es]),default:b(()=>[g(d)]),_:1}),as,ts,ps,g(n,{customClass:"undefined",sourceCode:`<template>
...
`},{highlight:b(()=>[cs]),default:b(()=>[g(o)]),_:1}),rs,ys,Fs,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[Ds]),default:b(()=>[g(i)]),_:1}),us,g(n,{customClass:"undefined",sourceCode:`<template>
  <xs-table :columns="columns" :data="data">
    <template #operations>
...
<\/script>
`},{highlight:b(()=>[is]),default:b(()=>[g(t)]),_:1}),Cs,ds,As,Es,ms,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[gs]),default:b(()=>[g(E)]),_:1}),bs,g(n,{customClass:"undefined",sourceCode:`<template>
  <xs-table :columns="columns" :data="data">
    <template #operations>
      <xs-button link type="danger" size="small">\u5220\u9664</xs-button>
    </template>
...
<\/script>
`},{highlight:b(()=>[fs]),default:b(()=>[g(C)]),_:1}),Bs,hs,xs,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[vs]),default:b(()=>[g(B)]),_:1}),ws,_s,ks,Ns,g(n,{customClass:"undefined",sourceCode:`<template>
  <xs-table :columns="columns" :data="data">
    <template #operations>
      <xs-button link type="danger" size="small">\u5220\u9664</xs-button>
    </template>
...
<\/script>
`},{highlight:b(()=>[$s]),default:b(()=>[g(m)]),_:1}),Ls,g(n,{customClass:"undefined",sourceCode:`<template>
  <div style="margin-bottom:12px;">
...
<\/script>
`},{highlight:b(()=>[Ss]),default:b(()=>[g(h)]),_:1}),Ts,g(n,{customClass:"undefined",sourceCode:`<template>
  <div style="margin-bottom:12px;">
...
<\/script>
`},{highlight:b(()=>[zs]),default:b(()=>[g(v)]),_:1}),Gs,g(n,{customClass:"undefined",sourceCode:`<template>
  <div style="margin-bottom:12px;">
...
<\/script>
`},{highlight:b(()=>[Vs]),default:b(()=>[g(_)]),_:1}),Os,g(n,{customClass:"undefined",sourceCode:`<template>
  <xs-table :columns="columns" :data="data">
...
<\/script>
`},{highlight:b(()=>[Rs]),default:b(()=>[g(k)]),_:1}),Is,Js,Ps,g(n,{customClass:"undefined",sourceCode:`<template>
  <xs-table :columns="columns" :data="data">
...
<\/script>
`},{highlight:b(()=>[js]),default:b(()=>[g(N)]),_:1}),Ms,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[qs]),default:b(()=>[g($)]),_:1}),Zs,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[Ys]),default:b(()=>[g(L)]),_:1}),Hs,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[Xs]),default:b(()=>[g(S)]),_:1}),Us,Ws,Ks,g(n,{customClass:"undefined",sourceCode:`<template>
  <xs-table :columns="columns" :data="data" />
</template>
<script>
  import { ref } from 'vue';
...
<\/script>
`},{highlight:b(()=>[Qs]),default:b(()=>[g(T)]),_:1}),sl,ll,g(n,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[ol]),default:b(()=>[g(z)]),_:1}),nl])}const pl=G(I,[["render",el]]);export{tl as __pageData,pl as default};
